### Hello, and thank you for contributing to the CreateWay SMP's KubeJS !
...
### Requirements
There are some specific requirements you need to follow when making and proposing changes to the mod. This ensures order, consistency, and organization.  
...
1. Fork the repository ([fork](https://github.com/Peperehobbit01/createway-mod/fork));
